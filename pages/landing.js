          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-2xl rounded-lg">
                  <div className="px-4 py-5 flex-auto backdrop-blur-md bg-white/30">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto ">
                ...
                <Link href="/">
                  <a href="#pablo" className="font-bold text-white mt-8">
                    Check Lorem Ipsum!
                  </a>
                </Link>
              </div>
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-black bg-white mr-3 shadow-lg">
                            <i className="fas fa-fingerprint"></i>
                          </span>
                        </div>
                        <div>
        ...
        <section className="relative block py-24 lg:pt-0">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center lg:-mt-64 -mt-48">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-2xl rounded-lg bg-white">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3">
                      <label
                        className="block uppercas text-xs font-bold mb-2"
                        htmlFor="message"
                      >
                        Message
                      </label>
