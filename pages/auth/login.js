            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-black border-0">
              <div className="rounded-t mb-0 px-6 py-6">
                <div className="text-center mb-3">
                  <h6 className="text-blueGray-300 text-sm font-bold">
                    Sign in with
                  </h6>
                </div>
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div className="text-blueGray-300 text-center mb-3 font-bold">
                  ...
                  <div>
                    <label className="inline-flex items-center cursor-pointer">
                      <input
                        id="customCheckLogin"
                        type="checkbox"
                        className="form-checkbox border-0 rounded text-blueGray-500 ml-1 w-5 h-5 ease-linear transition-all duration-150"
                      />
                      <span className="ml-2 text-sm font-semibold text-blueGray-300">
                        Remember me
                      </span>
                    </label>
                  </div>
