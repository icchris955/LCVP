          ...
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <h5 className="text-lg mt-0 mb-2 text-black">
                Get in touch with our team, we respond 1-2 business days.
              </h5>
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-black text-md font-bold mb-2">
                    Useful Links
                  </span>
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-black font-semibold py-1">
                Copyright © {new Date().getFullYear()} L-A-V-S{" "}
                <a
                  href=" "
                  className="text-blueGray-800 hover:text-blueGray-800"
                >
                  Group-11
                </a>
                .
