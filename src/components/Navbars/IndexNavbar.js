...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-1 navbar-expand-lg bg-black shadow-lg">
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <button
                  ...
                  type="button"
                >
                  <i className="fas fa-duotone fa-envelope mr-3"></i> Make
                  Inquiry
                </button>
              </li>
            </ul>
